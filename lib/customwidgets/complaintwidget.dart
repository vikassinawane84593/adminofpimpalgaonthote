              ...
              Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(complaintmodel.name,style: TextStyle(
                        fontWeight: FontWeight.bold,
                        fontSize: 16
                    ),
                    ),
                  ...
                  Padding(
                    ...
                    child: Text(complaintmodel.related,style: TextStyle(
                        fontWeight: FontWeight.bold,
                        fontSize: 14,
                        color: Colors.grey
                    ),
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        Padding(
                          padding: const EdgeInsets.only(left: 8),
                          child: Text(complaintmodel.date,style: TextStyle(
                              fontWeight: FontWeight.bold,
                              fontSize: 14,
                              color: Colors.grey
                          ),
                        ...
                        Padding(
                          ...
                          child: Text(complaintmodel.time,style: TextStyle(
                              fontWeight: FontWeight.bold,
                              fontSize: 14,
                              color: Colors.grey
                          ),
